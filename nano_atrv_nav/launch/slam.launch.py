...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('params',default_value=PathJoinSubstitution([pkg_nano_atrv_nav, 'config', 'slam.yaml']), description='Path to the SLAM Toolbox configuration file')
]
